...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    Onbord(
      ...
      description:
          "Tempat dimana kamu bisa mendapatkan produk yang kamu inginkan,dengan hasil handmade.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-1.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_1.png",
      title: "Dapatkan semua kebutuhan anda",
      description:
          "Jangan lupa untuk menambahkan barang ke kosong anda, atau menyimpannya di Keranjang.",
    ),
    Onbord(
    ...
    Onbord(
      ...
      description:
          "Barang yang anda beli akan dikirimkan ke alamat anda, dengan cepat dan aman.",
    ),
    Onbord(
